...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.createmodel_button.setGeometry(QRect(900, 127, 80, 24))
        self.train_button = QPushButton(self.tab1)
        self.train_button.setObjectName(u"train_button")
        self.train_button.setGeometry(QRect(900, 150, 80, 24))
        ...
        self.clearmodel_button.setGeometry(QRect(897, 220, 80, 24))
        self.forecast_button = QPushButton(self.tab1)
        self.forecast_button.setObjectName(u"forecast_button")
        self.forecast_button.setGeometry(QRect(900, 173, 80, 24))
