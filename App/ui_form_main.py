...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.forecast_progress_label.setGeometry(QRect(905, 583, 70, 16))
        self.createmodel_button = QPushButton(self.tab1)
        self.createmodel_button.setObjectName(u"createmodel_button")
        self.createmodel_button.setGeometry(QRect(900, 510, 80, 24))
        self.train_button = QPushButton(self.tab1)
        self.train_button.setObjectName(u"train_button")
        self.train_button.setGeometry(QRect(900, 533, 80, 24))
        ...
        self.layoutWidget1.setGeometry(QRect(30, 100, 150, 26))
        self.horizontalLayout_2 = QHBoxLayout(self.layoutWidget1)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.window50_button = QPushButton(self.layoutWidget1)
        ...
        self.window100_button = QPushButton(self.layoutWidget1)
        ...
        self.window500_button = QPushButton(self.layoutWidget1)
        ...
        self.windowmax_button = QPushButton(self.layoutWidget1)
        ...
        self.clearmodel_button = QPushButton(self.tab1)
        self.clearmodel_button.setObjectName(u"clearmodel_button")
        self.clearmodel_button.setGeometry(QRect(900, 603, 80, 24))
        self.forecast_button = QPushButton(self.tab1)
        self.forecast_button.setObjectName(u"forecast_button")
        self.forecast_button.setGeometry(QRect(900, 556, 80, 24))
        self.indicators_button = QPushButton(self.tab1)
        self.indicators_button.setObjectName(u"indicators_button")
        self.indicators_button.setGeometry(QRect(900, 140, 80, 24))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.train_button.setText(QCoreApplication.translate("MainWindow", u"Train Model", None))
        ...
        self.clearmodel_button.setText(QCoreApplication.translate("MainWindow", u"Clear Model", None))
        self.forecast_button.setText(QCoreApplication.translate("MainWindow", u"Forecast", None))
        self.indicators_button.setText(QCoreApplication.translate("MainWindow", u"Indicators", None))
